...
A. Create your own version of the examples in Example Set 3 in directory C:\public_html\syst10049\practice, choosing an appropriate name.
...
validate your code at W3C Validation Markup Service (remove all warnings and errors);
